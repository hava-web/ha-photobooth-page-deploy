...
const PrivacyPolicy: PageWithLayout &
  ...
  const htmlContent = `<h1 style="text-align: center; margin-top: 0pt; margin-bottom: 3pt;"><strong><span style="font-size: 20pt; font-family: 'UTM Avo', Arial, sans-serif;">CH&Iacute;NH SÁCH BẢO MẬT</span></strong></h1>
<h2 style="margin-top: 20pt; margin-bottom: 6pt;"><strong><span style="font-size: 14pt; font-family: 'UTM Avo', Arial, sans-serif;">1. Giới thiệu</span></strong></h2>
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Ch&iacute;nh s&aacute;ch bảo mật n&agrave;y (sau đ&acirc;y gọi tắt l&agrave; &ldquo;Ch&iacute;nh s&aacute;ch&rdquo;) được x&acirc;y dựng v&agrave; cập nhật bởi Fun Studio. (sau đ&acirc;y gọi tắt l&agrave; &ldquo;ch&uacute;ng t&ocirc;i&rdquo;, hay &ldquo;của ch&uacute;ng t&ocirc;i).</span></p>
<p style="color: #233477;" aria-hidden="true">&nbsp;</p>
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Phạm vi &aacute;p dụng của Ch&iacute;nh s&aacute;ch l&agrave; tất cả c&aacute;c đối tượng sử dụng, đăng k&yacute; sử dụng (sau đ&acirc;y gọi tắt l&agrave; &ldquo;Người d&ugrave;ng&rdquo;), Ứng dụng Fun Studio (sau đ&acirc;y gọi tắt l&agrave; Ứng dụng).&nbsp;</span></p>
<p style="color: #233477;" aria-hidden="true">&nbsp;</p>
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Ch&iacute;nh s&aacute;ch bảo mật được x&acirc;y dựng nhằm cho Người d&ugrave;ng biết được Ứng dụng c&oacute; thể thu thập, sử dụng, chia sẻ v&agrave; xử l&yacute; th&ocirc;ng tin c&aacute; nh&acirc;n m&agrave; Người d&ugrave;ng đ&atilde; cung cấp cho ch&uacute;ng t&ocirc;i như thế n&agrave;o. Ch&iacute;nh s&aacute;ch n&agrave;y được x&acirc;y dựng dựa tr&ecirc;n quy định ph&aacute;p luật Việt Nam li&ecirc;n quan đến bảo mật Dữ liệu c&aacute; nh&acirc;n. Bằng việc trao cho ch&uacute;ng t&ocirc;i th&ocirc;ng tin c&aacute; nh&acirc;n, sử dụng c&aacute;c dịch vụ tr&ecirc;n Ứng dụng nghĩa l&agrave; Người d&ugrave;ng đồng &yacute; th&ocirc;ng tin c&aacute; nh&acirc;n của Người d&ugrave;ng sẽ được thu thập, sử dụng như được n&ecirc;u trong Ch&iacute;nh s&aacute;ch n&agrave;y. Trường hợp Người d&ugrave;ng kh&ocirc;ng đồng &yacute; với Ch&iacute;nh s&aacute;ch n&agrave;y, Người d&ugrave;ng kh&ocirc;ng được sử dụng Ứng dụng.</span></p>
<p style="color: #233477;" aria-hidden="true">&nbsp;</p>
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Ch&uacute;ng t&ocirc;i c&oacute; quyền được sửa đổi, bổ sung bất kỳ v&agrave; to&agrave;n bộ nội dung của Ch&iacute;nh s&aacute;ch n&agrave;y tại bất kỳ thời điểm n&agrave;o m&agrave; kh&ocirc;ng cần b&aacute;o trước hay cần c&oacute; sự đồng &yacute; trước của Người d&ugrave;ng.</span></p>
<h2 style="margin-top: 20pt; margin-bottom: 6pt;"><strong><span style="font-size: 14pt; font-family: 'UTM Avo', Arial, sans-serif;">2. Thu thập Dữ liệu c&aacute; nh&acirc;n</span></strong></h2>
<p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Người d&ugrave;ng khi sử dụng Ứng dụng điện thoại của Fun Studio c&oacute; thể được y&ecirc;u cầu cung cấp Dữ liệu c&aacute; nh&acirc;n để sử dụng c&aacute;c dịch vụ v&agrave; tiện &iacute;ch được cung cấp bởi ứng dụng điện thoại của Fun Studio. Dữ liệu c&aacute; nh&acirc;n l&agrave; c&aacute;c th&ocirc;ng tin gắn liền với một con người cụ thể v&agrave; gi&uacute;p x&aacute;c định danh t&iacute;nh một con người cụ thể. Dữ liệu c&aacute; nh&acirc;n c&oacute; thể l&agrave;: Họ t&ecirc;n, ng&agrave;y th&aacute;ng năm sinh, địa chỉ li&ecirc;n lạc, nơi cư tr&uacute;, email, số điện thoại, số định danh c&aacute; nh&acirc;n, nghề nghiệp, &hellip; .Ch&uacute;ng t&ocirc;i sẽ/c&oacute; thể thu thập Dữ liệu c&aacute; nh&acirc;n của Người d&ugrave;ng khi Người d&ugrave;ng đăng k&yacute; v&agrave;/hoặc sử dụng c&aacute;c dịch vụ, tiện &iacute;ch tr&ecirc;n Ứng dụng.</span></p>
<h2 style="margin-top: 12pt; margin-bottom: 12pt;"><strong><span style="font-size: 14pt; font-family: 'UTM Avo', Arial, sans-serif;">3. Mục đ&iacute;ch thu thập, sử dụng v&agrave; chia sẻ Dữ liệu c&aacute; nh&acirc;n</span></strong></h2>
<p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Ch&uacute;ng t&ocirc;i thu thập, lưu trữ v&agrave; xử l&yacute; Dữ liệu c&aacute; nh&acirc;n của người d&ugrave;ng v&agrave;/hoặc được người d&ugrave;ng cung cấp để phục vụ mục đ&iacute;ch sau:&nbsp;</span></p>
<ul style="margin-top: 0px; margin-bottom: 0px; padding-inline-start: 48px;">
  <li style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">
...
<p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Mặc d&ugrave; ch&uacute;ng t&ocirc;i đ&atilde; c&oacute; c&ocirc;ng nghệ cập nhật v&agrave; thủ tục nội bộ để giữ cho c&aacute;c Dữ liệu c&aacute; nh&acirc;n của Người d&ugrave;ng an to&agrave;n khỏi những kẻ x&acirc;m nhập, nhưng kh&ocirc;ng c&oacute; đảm bảo rằng c&aacute;c c&ocirc;ng nghệ hoặc thủ tục như vậy c&oacute; thể loại bỏ tất cả c&aacute;c rủi ro về trộm cắp, mất m&aacute;t hoặc sử dụng sai. Ch&uacute;ng t&ocirc;i sử dụng phương ph&aacute;p hợp l&yacute; để ngăn chặn truy cập tr&aacute;i ph&eacute;p, để duy tr&igrave; độ ch&iacute;nh x&aacute;c của dữ liệu v&agrave; để đảm bảo sử dụng đ&uacute;ng th&ocirc;ng tin ch&uacute;ng t&ocirc;i lưu trữ.</span></p>
<h2 style="margin-top: 12pt; margin-bottom: 12pt;"><strong><span style="font-size: 14pt; font-family: 'UTM Avo', Arial, sans-serif;">5. Th&ocirc;ng tin li&ecirc;n hệ&nbsp;</span></strong></h2>
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Nếu Người d&ugrave;ng c&oacute; thắc mắc về Ch&iacute;nh s&aacute;ch n&agrave;y, h&atilde;y li&ecirc;n hệ với ch&uacute;ng t&ocirc;i theo th&ocirc;ng tin sau:&nbsp;</span></p>
<ul style="margin-top: 0px; margin-bottom: 0px; padding-inline-start: 48px;">
  <li style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">
  ...
  return (
    <>
      <PageSeo path="/chinh-sach-bao-mat" />
