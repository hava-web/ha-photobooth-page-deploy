...
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Tổ chức, c&aacute; nh&acirc;n sử dụng dịch vụ, tiện &iacute;ch tr&ecirc;n Ứng dụng Fun tự chịu tr&aacute;ch nhiệm trước ph&aacute;p luật:&nbsp;</span></p>
...
<br />
<p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">Tổ chức, c&aacute; nh&acirc;n sử dụng dịch vụ, tiện &iacute;ch tr&ecirc;n Ứng dụng Fun kh&ocirc;ng được thực hiện những h&agrave;nh vi sau:&nbsp;</span></p>
<ul style="margin-top: 0px; margin-bottom: 0px; padding-inline-start: 48px;">
  <li style="font-size: 13pt; font-family: 'UTM Avo', Arial, sans-serif;">
...
<br />
<p style="line-height: 1.656; text-align: justify; background-color: #ffffff; margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 12pt; font-family: 'UTM Avo', Arial, sans-serif;">Việc vi phạm Điều Khoản Dịch Vụ n&agrave;y c&oacute; thể dẫn tới một số h&agrave;nh động, bao gồm bất kỳ hoặc tất cả c&aacute;c h&agrave;nh động sau:</span></p>
<ul style="margin-top: 0px; margin-bottom: 0px; padding-inline-start: 48px;">
  <li style="font-size: 12pt; font-family: 'UTM Avo', Arial, sans-serif;">
